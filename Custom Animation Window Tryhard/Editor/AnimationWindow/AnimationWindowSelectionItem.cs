...
using UnityEditor;
using ISelectionBinding = UnityEditor.Enemeteen.ISelectionBinding;
...
namespace UnityEditorInternal.Enemeteen {
	internal class AnimationWindowSelectionItem : ScriptableObject, System.IEquatable<AnimationWindowSelectionItem>, ISelectionBinding {
		...
		private Component closestAnimationPlayerComponentInparents;
		public virtual Component animationPlayer {
			get {
				if (closestAnimationPlayerComponentInparents == null) {
					if (gameObject != null) {
						closestAnimationPlayerComponentInparents = AnimationWindowUtility.GetClosestAnimationPlayerComponentInParents(gameObject.transform);
					}
				}
